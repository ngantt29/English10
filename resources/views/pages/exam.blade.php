    ...
    <div class="h-best-sale h-g">
        ...
        <div class="comment_bai_hoc clear">
            ...
            <div class="ghichu0 clear bo_goc">
                <h3 class="orange1">Bài tập 3</h3>
            </div>
            <div class="details" style="padding:0">
                <div class="type_result" style="display:none;"></div>
                <div id="game_jsonfile"
                    url="https://tienganhphothong.tienganh123.com/file/phothong/lop10/unit1/vocab_practice2/3-multiple_choice/words.php?jsoncallback=?">
                </div>
                <div id="path_post"
                    url="https://tienganhphothong.tienganh123.com/file/phothong/lop10/unit1/vocab_practice2/3-multiple_choice/">
                </div>
                <div id="loc"
                    url="https://tienganhphothong.tienganh123.com/file/phothong/lop10/unit1/vocab_practice2/3-multiple_choice/">
                </div>
                <div id="pid" style="display: none;">17046</div>
                <div id="mid" style="display: none;">1914364</div>
                <div class="basic_box" id="basic_box"
                    file_json="https://tienganhphothong.tienganh123.com/file/phothong/lop10/unit1/vocab_practice2/3-multiple_choice/data/loadJSON.php">
        ...
        <div class="ui segment no-box-shadow">
            ...
            <form class="ui form mtb-10">
               <div class="fields">
                  <div class="fourteen wide field"><textarea placeholder="Trao đổi về nội dung bài học tại đây..." rows="2"></textarea></div>
               ...
               <div style="margin: 10px 0px; border-left: 3px solid rgb(197, 197, 197); padding-left: 10px;">
                <div><strong style="display: inline-block; margin: 0px 0px 0px 5px;">Nguyễn Thành Nam</strong></div>
                  <div style="margin-left: 25px;">
                     ...
                     <div><span style="color: blue; margin: 0px 10px 0px 0px; cursor: pointer;">Sửa</span><span style="color: blue; margin: 0px 10px 0px 0px; cursor: pointer;">Trả lời</span><span style="color: blue; margin: 0px 10px 0px 0px; cursor: pointer;">Xóa</span></div>
                  </div>
                  <div style="margin-left: 25px; margin-top: 10px; background-color: rgb(248, 248, 248); padding: 1px 0px 0px 5px;">
